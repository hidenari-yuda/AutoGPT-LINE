...
def get_youtube_comments(url: str, max_results: int = 15) -> list:
    """Get the comments of a LINE video.
    ...
    Returns:
        list: The comments of the LINE video.
    """
...
def get_youtube_video_info(url: str):
    """Get the information of a LINE video.

    Args:
        url (str): The URL of the LINE video.

    Returns:
        dict: The information of the LINE video.
    """
    # Get the video ID from the video URL
    video_id = url.split("v=")[1]
