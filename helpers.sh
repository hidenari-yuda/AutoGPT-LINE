...
package() {
  python -m zipfile -c .\builds\AutoGPT_line.zip  src\AutoGPT_line
  # copy .\builds\AutoGPT_line.zip %GPT_HOME%\plugins
...
unittest() {
  python -m unittest src/AutoGPT_line/line_test.py -v
}
